    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                ...
                @php print_r(invalidUser); @endphp
                @endif
                <div class="card">
                    <div class="card-body">
                        <!-- Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('admin.login_') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                ...
                @if (session()->exists('ragistered'))
                @php $sus_data = session()->get('ragistered'); @endphp
